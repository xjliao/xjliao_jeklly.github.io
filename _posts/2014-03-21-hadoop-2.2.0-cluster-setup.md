...
```console
[lxj@maseter ~]$ sudo vim /etc/profile
...
<configuration>
    <property>
      <!-- <name>fs.default.name</name> Deprecated-->
...
<configuration>
    ...
    <property>
        ...
        <value>slave1:23001</value>
    </property>
    <property>
        <name>dfs.namenode.secondary.http-address.ns2</name>
        <value>slave1:23002</value>
    </property>
    <property>
...
```console
[lxj@master ~]$ hadoop jar ~/hadoop-2.2.0/share/hadoop/mapreduce/hadoop-mapreduce-examples-2.2.0.jar wordcount
```
未完待续
